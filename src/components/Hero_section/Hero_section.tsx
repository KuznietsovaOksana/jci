      ...
      {isMobile && (
        <div className={css.mobileVersion}>
          <h1 className={css.title}>
            ...
            <br />is a leading global 
            <span className={css.accentTitle}><br />network of young 
            <br />leaders</span>
          </h1>

          <p className={css.description}>
            We are a non-profit organization within a global network of Junior Chamber International (JCI) and are currently focusing on mitigating the effects of the russian invasion countrywide.
          </p>

          <div className={css.cta}>
            <MainButton type='button' text='Join us' style='primary' paddings={112} onClick={()=>console.log('Join us')}/>
            <MainButton
              type='button'
              text='Donate'
              style='secondary'
        ...
        <div className={css.tabletVersion}>
          ...
          <div className={css.infoblock}>
            <div className={css.textblock}>
              ...
              <div className={css.cta}>
                <MainButton type='button' text='Join us' style='primary' paddings={100} onClick={()=>console.log('Join us')}/>
                <MainButton
                  type='button'
                  text='Donate'
                  style='secondary'
